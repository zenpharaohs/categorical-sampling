...
def bench_case(name: str, K: int, p: np.ndarray, size: int) -> None:
    ...
    for method in methods:
        cs.multinomial(K, p, size=100, seed=1, method=method)
...
def main() -> None:
    ...
    print("case,method,K,d,size,native_s,numpy_s,speedup,max_mean_err,numpy_max_mean_err")
